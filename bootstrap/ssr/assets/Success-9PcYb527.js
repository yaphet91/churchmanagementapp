...
const Success = () => {
  ...
  return /* @__PURE__ */ jsx("div", { className: `${theme === "light" ? "gradientBg" : "darkBg"} rounded-sm md:p-9 px-4 py-9 lg:min-h-[470px]`, children: /* @__PURE__ */ jsx("div", { className: "flex flex-col items-center justify-center text-black", children: /* @__PURE__ */ jsxs("div", { className: "bg-white black_dent w-5/6 h-[400px] mt-3 relative border rounded-lg dark:border-gray-500", children: [
    ...
    animationStage >= 2 && /* @__PURE__ */ jsxs("div", { className: "content slide-up flex flex-col -mt-20 items-center justify-center relative", children: [
      ...
      /* @__PURE__ */ jsxs("div", { className: "space-x-4 mt-14", children: [
        ...
        /* @__PURE__ */ jsx("button", { onClick: goToForm, className: "btnPrimary border", children: t("Add Family Members") })
      ] })
    ] })
  ] }) }) });
};
