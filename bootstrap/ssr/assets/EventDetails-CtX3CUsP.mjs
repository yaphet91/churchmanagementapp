...
import EventQRCode from "./EventQrCode-DC5TSaX3.mjs";
...
const EventDetails = ({ event }) => {
  ...
  const handleCheckIn = () => {
    Inertia.visit("/event/attendance", { event });
  };
  ...
  return /* @__PURE__ */ jsx(AdminLayout, { children: /* @__PURE__ */ jsxs("div", { className: "space-x-2", children: [
    ...
    /* @__PURE__ */ jsxs("div", { className: `flex flex-row gap-4 ${theme === "light" ? "bg-gray-300" : "darkBg"} rounded-sm md:p-6 md:pt-9 px-4 py-9`, children: [
      /* @__PURE__ */ jsxs("div", { className: `w-[50%] `, children: [
        ...
        /* @__PURE__ */ jsxs("div", { className: "w-[75%]", children: [
          /* @__PURE__ */ jsx("p", { className: "py-2 text-black dark:text-white", children: "Attending groups" }),
          /* @__PURE__ */ jsx("div", { className: "grid grid-cols-2 gap-2 items-start", children: event.groups.map((group) => /* @__PURE__ */ jsx("div", { className: "p-2 border rounded-md bg-gray-500 text-white border-gray-300 dark:border-gray-700", children: /* @__PURE__ */ jsx("p", { children: group.title }) }, group.id)) })
        ] })
      ] }),
      /* @__PURE__ */ jsx("div", { className: "w-[49%]", children: /* @__PURE__ */ jsxs("div", { className: "flex items-start justify-end space-x-2 text-black dark:text-white", children: [
        ...
        /* @__PURE__ */ jsx("button", { className: "flex items-start justify-start px-4 py-2 rounded-md gap-2 border border-gray-500 text-sm bg-gray-400 dark:bg-gray-600 hover:bg-green-800", onClick: () => viewQrCode(), children: /* @__PURE__ */ jsx(QrCode, {}) })
      ] }) })
    ] }),
    /* @__PURE__ */ jsx(EventQRCode, { event, isOpen: openQrCode, onClose: () => setOpenQrCode(false) })
  ] }) });
};
export {
