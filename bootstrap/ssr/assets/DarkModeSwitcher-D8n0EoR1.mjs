...
import { s as setDrawerOpen } from "./TooltipContext-CXfF4_Yf.mjs";
import { useSelector, useDispatch } from "react-redux";
import { usePage } from "@inertiajs/react";
import { t as toggleTheme } from "./themeSlice-BmOV-XST.mjs";
...
const DropdownUser = () => {
  ...
  const adminName = admin.name || ((_a = props.admin) == null ? void 0 : _a.name) || "Local Admin";
  const userName = user.name || ((_c = (_b = props.auth) == null ? void 0 : _b.user) == null ? void 0 : _c.name) || "Guest User";
  const toggleDrawer = () => {
