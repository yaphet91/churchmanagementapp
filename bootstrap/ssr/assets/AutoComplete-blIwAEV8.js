...
const AutoComplete = ({ value, onChange, label, options, disabled }) => {
  ...
  return /* @__PURE__ */ jsx("div", { className: "space-y-3 w-full", children: /* @__PURE__ */ jsx(Listbox, { value, onChange, disabled, children: ({ open }) => /* @__PURE__ */ jsxs(Fragment, { children: [
