...
import { SlidersHorizontal, MessageSquareMore, Mail, BellRing, Download, LayoutGrid, ArrowUp, ArrowDown, ArrowDownUp } from "lucide-react";
...
const UsersTable = () => {
  ...
  const columns = useMemo(() => [
    ...
    },
    {
      ...
      cell: (info2) => {
        const name = info2.getValue();
        return /* @__PURE__ */ jsx("button", { onClick: () => viewRow(info2.row.original), children: /* @__PURE__ */ jsx("span", { className: "hover:underline", children: name }) });
      },
      // filterFn: 'fuzzy',
    ...
    {
      accessorFn: (row) => `${row.has_completed_membership_form}`,
      //note: normal non-fuzzy filter column - case sensitive
      id: "has_completed_membership_form",
      cell: (info2) => info2.getValue(),
    ...
    },
    {
      ...
      cell: (info2) => {
        const role = info2.getValue();
        return /* @__PURE__ */ jsx("button", { onClick: () => viewRow(info2.row.original), children: /* @__PURE__ */ jsx("span", { className: "hover:underline", children: role }) });
      },
      // filterFn: 'fuzzy',
      filterFn: fuzzyFilter,
      // Use the updated filter function.
  ...
  const table = useReactTable({
    ...
    initialState: {
      columnOrder: ["select", "username", "email", "has_completed_membership_form"],
...
const Users = () => {
  return /* @__PURE__ */ jsx(AdminLayout, { children: /* @__PURE__ */ jsx(UsersTable, {}) });
};
export {
  Users as default
};
