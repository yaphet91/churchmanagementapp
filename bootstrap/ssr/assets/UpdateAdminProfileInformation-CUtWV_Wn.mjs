...
import "react-redux";
import "react";
function UpdateAdminProfileInformation({ mustVerifyEmail, status, className = "" }) {
  ...
  return /* @__PURE__ */ jsxs("section", { className, children: [
    /* @__PURE__ */ jsxs("header", { children: [
      /* @__PURE__ */ jsx("h2", { className: "text-lg font-semibold text-gray-900 dark:text-blue-300", children: "Profile Information" }),
      /* @__PURE__ */ jsx("p", { className: "mt-1 text-sm text-gray-600 dark:text-gray-300", children: "Update your account's profile information and email address." })
    ] }),
...
export {
  UpdateAdminProfileInformation as default
};
