...
import EventForm from "./EventForm-CS-dz8mX.mjs";
...
import { a as setSelectedEvent } from "./eventSlice-cpfWu0eT.mjs";
...
import "react-quill";
import "./CustomQuill-p1ZcDQgz.mjs";
...
const EventsMember = () => {
  ...
  const handleEventClick = async (event) => {
    try {
      ...
      Inertia.visit(`/events/member/${event.id}`, { event });
    } catch (error) {
        ...
        "div",
        {
          ...
          children: [
            ...
            /* @__PURE__ */ jsxs("div", { className: "flex items-center p-4 justify-start space-x-6", children: [
              /* @__PURE__ */ jsx("img", { src: event.image_url, alt: "Event", className: "rounded-md h-[90px] w-[120px]" }),
