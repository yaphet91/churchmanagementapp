...
const Confirmation = () => {
  ...
  return /* @__PURE__ */ jsxs("div", { className: "space-y-2", children: [
    /* @__PURE__ */ jsx("div", { className: `${theme === "light" ? "whiterBg" : "darkBg"} rounded-sm md:p-9 px-4 py-9 `, children: /* @__PURE__ */ jsx("div", { className: "p-6 md:p-4", children: /* @__PURE__ */ jsxs("div", { className: "mb-10", children: [
      /* @__PURE__ */ jsxs("h1", { className: "text-2xl text-gray-500 dark:text-gray-300 uppercase mb-4", children: [
        "1. ",
        t("steps.personalDetails")
      ] }),
      /* @__PURE__ */ jsxs("div", { className: "flex flex-row items-start justify-between space-x-2", children: [
        ...
        /* @__PURE__ */ jsxs("div", { className: "w-1/2", children: [
          ...
          /* @__PURE__ */ jsx(Box, { children: /* @__PURE__ */ jsxs("p", { children: [
            " ስም ኣደ: ",
            /* @__PURE__ */ jsx(NSpan, { children: member.motherFullNameT })
          ] }) }),
          /* @__PURE__ */ jsx(Box, { children: /* @__PURE__ */ jsxs("p", { children: [
            "ዕለተ ልደት: ",
            /* @__PURE__ */ jsx(NSpan, { children: member.birthday })
    ...
    /* @__PURE__ */ jsx("div", { className: `${theme === "light" ? "whiterBg" : "darkBg"} rounded-sm md:p-9 px-4 py-9 `, children: /* @__PURE__ */ jsx("div", { className: "p-6 md:p-4 text-gray-500 dark:text-gray-300", children: /* @__PURE__ */ jsxs("div", { className: "mb-10", children: [
    ...
    /* @__PURE__ */ jsx("div", { className: `${theme === "light" ? "whiterBg" : "darkBg"} rounded-sm md:p-9 px-4 py-9 `, children: /* @__PURE__ */ jsx("div", { className: "p-6 md:p-4 text-gray-500 dark:text-gray-300", children: /* @__PURE__ */ jsxs("div", { className: "", children: [
      /* @__PURE__ */ jsxs("h1", { className: "text-2xl uppercase", children: [
        "5. ",
...
const Box = ({ children, className = "" }) => {
  return /* @__PURE__ */ jsx("div", { className: `my-2 ${className} p-2.5 rounded-lg text-md font-bold text-gray-500 dark:text-gray-400 border
     dark:border-gray-600 border-gray-400  md:uppercase`, children });
};
