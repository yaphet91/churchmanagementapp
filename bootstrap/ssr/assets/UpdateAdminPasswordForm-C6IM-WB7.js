...
import "react-redux";
function UpdateAdminPasswordForm({ className = "" }) {
  ...
  return /* @__PURE__ */ jsxs("section", { className, children: [
    /* @__PURE__ */ jsxs("header", { children: [
      /* @__PURE__ */ jsx("h2", { className: "text-lg font-medium text-gray-900 dark:text-blue-300", children: "Update Password" }),
      /* @__PURE__ */ jsx("p", { className: "mt-1 text-sm text-gray-600 dark:text-gray-300", children: "Ensure your account is using a long, random password to stay secure." })
    ] }),
...
export {
  UpdateAdminPasswordForm as default
};
