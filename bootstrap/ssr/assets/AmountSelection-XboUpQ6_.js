...
const PaymentAmountCard = ({ onClick, amount, animate, transition, paymentAmount }) => {
  return /* @__PURE__ */ jsx(
    motion.div,
    {
      ...
      animate,
      transition,
      children: /* @__PURE__ */ jsxs("h2", { className: "text-lg font-semibold uppercase p-2", children: [
        amount,
        " AED"
      ] })
    }
...
const PaymentAmountCard$1 = PaymentAmountCard;
...
const ConfirmPaymentModal$1 = ConfirmPaymentModal;
