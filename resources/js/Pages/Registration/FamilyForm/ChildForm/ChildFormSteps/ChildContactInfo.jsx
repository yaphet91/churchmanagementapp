...
// import { validateChildContactInfo } from '../Validations';
...
const ChildContactInfo = () => {
  ...
  const handlePhoneChange = (e) => {
    ...
    if (input.length === 1 && input.startsWith('0')) {
      ...
      // Though for type="number" fields, direct negative input is unlikely without explicit child action
      // setPhone('');
      handleInputChange('phone', '')
  ...
  return (
    <section className={`${theme === 'light' ? 'gradientBg' : 'darkBg'} rounded-sm md:p-9 px-4 py-9 lg:min-h-[470px]`} id='child-contact-info'>
      <h2 className='text-2xl md:text-3xl font-bold py-6 flex items-center justify-center text-gray-200'>
        {t("Contact Information")}<span className='hidden md:flex ml-4'><FontAwesomeIcon icon={faMapLocationDot} /></span>
      </h2>
      <motion.div
        ...
        <div className='md:flex flex-row gap-6 mt-4'>
          <div className='flex-1'>
            {!errors?.emergencyContactNumber
              ? <InputLabel htmlFor="emergencyContactNumber" value={t("Parent/guardian Contact Number")} />
          ...
          <div className='flex-1 mt-4 md:mt-0'>
            {!errors?.contactRelation
              ? <InputLabel htmlFor="contactRelation" value={t("Specify Contact Relationship")} />
        ...
        <div className='md:flex flex-row gap-6 mt-4'>
          <div className='flex-1 mt-3'>
            <div className='flex flex-row justify-between'>
              ...
              <label className='px-4 flex cursor-pointer text-sm select-none items-center text-gray-200 underline'>
                <Checkbox
            ...
            <TextInput
              ...
              name="whatsApp"
              value={child.whatsApp} // Ensure the value is formatted as a string
          ...
          <div className='flex-1 mt-3'>
            <InputLabel htmlFor="postalCode" value={t("P.O.Box (Optional)")} />
...
export default ChildContactInfo;
