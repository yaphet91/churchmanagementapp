...
export default function AdminLogin({ status, canResetPassword }) {
    ...
    const handleFaceLogin = () => {
        window.location.href = '/admin/auth/facebook';
    }
    const handleLinkedinLogin = () => {
        window.location.href = '/admin/auth/linkedin';
    }
    ...
    return (
        <GuestAdminLayout>
            ...
            <div className='pb-10 flex items-center justify-center'>
                <h1 className='text-4xl font-bold mb-2 text-indigo-700/[0.8]'>{t('Admin Login')}</h1>
            </div>
