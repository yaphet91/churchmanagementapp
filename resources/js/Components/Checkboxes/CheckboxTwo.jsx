...
const CheckboxTwo = ({ id, checked, label, onChange, name }) => {
    ...
    // // Effect to communicate changes to the parent component
    // useEffect(() => {
    //     if (onChange) {
    //         onChange(checked);
    //     }
    ...
    return (
        <div>
            <label
                htmlFor={id}
                className="flex cursor-pointer text-sm font-semibold select-none items-center text-gray-700 dark:text-gray-300"
            >
