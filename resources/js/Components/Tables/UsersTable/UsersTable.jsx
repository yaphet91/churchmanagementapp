...
const UsersTable = () => {
    ...
    const columns = useMemo(() => [
        ...
        {
            id: 'username',  // Unique identifier for the column.
            header: 'User Name',  // Text to display in the column header.
        ...
        {
            accessorFn: row => `${row.has_completed_membership_form}`, //note: normal non-fuzzy filter column - case sensitive
        ...
        {
            id: 'role',  // Unique identifier for the column.
            header: 'Role',  // Text to display in the column header.
    ...
    const table = useReactTable({
        ...
        initialState: {
            columnOrder: ['select', 'username', 'email', 'has_completed_membership_form',], //customize the initial column order
            columnVisibility: {
