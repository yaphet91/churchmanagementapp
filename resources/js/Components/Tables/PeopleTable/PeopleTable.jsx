...
import MemberEditorModal from '@/Components/Modals/Editor/MemberEditorModal';
...
const PeopleTable = () => {
    ...
    const handleSave = (updatedMember) => {
        // Make an API call to update the member in the database
        axios.put(`/admin/update-membership/${updatedMember.id}`, updatedMember)
            .then(response => {
                // Handle successful response
                setIsEditModalOpen(false);
                // Optionally refresh data or update state with the updated member
            })
            .catch(error => {
                // Handle error
    ...
    return (
        <div>
            ...
            <MemberEditorModal isOpen={isEditModalOpen} onSave={handleSave} onClose={() => setIsEditModalOpen(false)} data={dataToBeEdited} />
