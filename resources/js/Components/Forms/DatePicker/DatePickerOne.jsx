...
import 'flatpickr/dist/flatpickr.min.css'; // Don't forget to import CSS
...
const DatePickerOne = ({ updateFormState, initialDate }) => {
    ...
    useEffect(() => {
        ...
        // Cleanup function to destroy Flatpickr instance when component unmounts or props change
        return () => {
            if (fpInstance.current) {
                fpInstance.current.destroy();
            }
        };
    }, [updateFormState, initialDate]); // Add dependencies here if they are meant to re-initialize Flatpickr
    ...
    return (
        <div>
            ...
            <div className="relative md:w-[255px] w-[435px] border border-gray-400 rounded-md">
                <input
                    ref={datePickerRef}
                    type="text"
                    ...
                    // value={date} // Set the input value to the state
                    readOnly // Makes the input readonly since flatpickr handles changes
                />

                <div className="pointer-events-none absolute inset-0 left-auto right-7 flex items-center">
                    {/* Icon SVG */}
                    <svg
                        width="18"
                        height="18"
