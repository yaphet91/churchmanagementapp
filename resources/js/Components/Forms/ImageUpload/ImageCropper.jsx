...
const ImageCropper = ({ closeModal, updateAvatar }) => {
    ...
    const handleCropImage = (e) => {
        ...
        // Assuming setCanvasPreview properly draws the cropped image on the canvas
        setCanvasPreview(
            imgRef.current,
            ...
            previewCanvasRef.current.toBlob(blob => {
                ...
                updateAvatar(blob, blob.size); // Update avatar with the blob instead of Data URL
                closeModal();
            }, 'image/png'); // Specify the format and quality if needed
        }).catch(error => console.error("Error in creating blob:", error));
    };
