...
const Switcher = ({ id, enabled, onChange }) => {
    ...
    //     onChange(newState);  // Send the new state to the parent component
    // };
            ...
            <label htmlFor={id} className="flex cursor-pointer select-none items-center">
                <div className="relative ">
                    <input
                        ...
                        onChange={onChange}
                    />
                    <div className={`block h-5 w-12 rounded-full  ${enabled ? 'bg-blue-300' : 'bg-gray-600'} dark:bg-[#5A616B]`}></div>
                    <div
